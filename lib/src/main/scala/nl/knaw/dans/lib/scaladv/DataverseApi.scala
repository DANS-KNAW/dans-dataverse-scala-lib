...
import nl.knaw.dans.lib.scaladv.model.DefaultRole.DefaultRole
import nl.knaw.dans.lib.scaladv.model._
import nl.knaw.dans.lib.scaladv.model.dataset.{ DatasetCreationResult, Embargo }
import nl.knaw.dans.lib.logging.DebugEnhancedLogging

import java.net.URI
import scala.util.Try

class DataverseApi private[scaladv](dvId: String, configuration: DataverseInstanceConfig) extends HttpSupport with DebugEnhancedLogging {
  trace(dvId)
