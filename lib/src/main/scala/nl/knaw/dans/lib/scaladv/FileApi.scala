...
import nl.knaw.dans.lib.scaladv.model.DataMessage
import nl.knaw.dans.lib.scaladv.model.dataset.FileList
import nl.knaw.dans.lib.scaladv.model.file.prestaged.PrestagedFile
import nl.knaw.dans.lib.scaladv.model.file.{ DetectionResult, FileMeta, Provenance }
...
class FileApi private[scaladv](filedId: String, isPersistentFileId: Boolean, configuration: DataverseInstanceConfig) extends TargetedHttpSupport with DebugEnhancedLogging {
