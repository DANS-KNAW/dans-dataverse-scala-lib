...
import nl.knaw.dans.lib.scaladv.model.search.SearchResult
...
class SearchApi private[scaladv](configuration: DataverseInstanceConfig) extends HttpSupport with DebugEnhancedLogging {
  trace(())
