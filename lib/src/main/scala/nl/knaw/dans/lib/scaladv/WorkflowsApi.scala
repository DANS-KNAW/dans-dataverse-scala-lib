...
import nl.knaw.dans.lib.scaladv.model.ResumeMessage
...
class WorkflowsApi private[scaladv](configuration: DataverseInstanceConfig) extends HttpSupport with DebugEnhancedLogging {
